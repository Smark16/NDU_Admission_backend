...
ROLE_SERVICE_CATALOG: list[CategoryDef] = [
    {
        ...
        "services": [
            ...
            _svc("manage_batches", "Manage intakes / batches (admin)", _cols(
                view="accounts.manage_batches",
                edit="accounts.manage_batches",
            )),
            ...
            _svc("communication_templates", "Communication templates", _cols(
                view="accounts.manage_communication_templates",
                edit="accounts.manage_communication_templates",
            )),
            _svc("offer_letter_templates", "Offer letter templates", _crud("AdmissionLetter", "offerlettertemplate")),
            _svc("admission_reports", "Admission reports", _cols(view="AdmissionReports.view_admissionreports")),
    ...
    },
    {
        ...
        "services": [
            ...
            _svc("academic_enrollment_admin", "Academic enrollment admin", _cols(
                view="accounts.manage_academic_enrollment",
                edit="accounts.manage_academic_enrollment",
            )),
            ...
            _svc("manage_change_requests", "Manage change requests", _cols(
                view="admissions.manage_admission_change_requests",
                edit="admissions.manage_admission_change_requests",
            )),
            ...
            _svc("manage_id_cards", "Manage ID cards", _cols(
                view="admissions.manage_id_cards",
                edit="admissions.manage_id_cards",
            )),
    ...
    },
    {
        ...
        "services": [
            ...
            _svc("manage_curriculum", "Manage curriculum", _cols(
                view="accounts.manage_curriculum",
                edit="accounts.manage_curriculum",
            )),
            _svc("course_catalog", "Course catalog", _crud("Programs", "coursecatalogunit")),
            _svc("manage_course_catalog", "Manage course catalog", _cols(
                view="accounts.manage_course_catalog",
                edit="accounts.manage_course_catalog",
            )),
    ...
    },
    {
        ...
        "services": [
            ...
            _svc("program_scheduling", "Timetable scheduling", _cols(
                view="accounts.manage_program_scheduling",
                edit="accounts.manage_program_scheduling",
            )),
            ...
            _svc("manage_faculty_attendance", "Manage faculty lecture attendance", _cols(
                view="Programs.manage_faculty_lecture_attendance",
                edit="Programs.manage_faculty_lecture_attendance",
            )),
        ],
    },
    {
        ...
        "services": [
            ...
            _svc("manage_exam_schedule", "Manage exam schedule", _cols(
                view="examinations.manage_exam_schedule",
                edit="examinations.manage_exam_schedule",
            )),
            ...
            _svc("manage_marks_windows", "Manage marks windows", _cols(
                view="examinations.manage_marks_windows",
                edit="examinations.manage_marks_windows",
            )),
            _svc("retakes", "Exam retakes", _crud("examinations", "examretakeregistration")),
            _svc("manage_retakes", "Manage retakes", _cols(
                view="examinations.manage_retakes",
                edit="examinations.manage_retakes",
            )),
    ...
    },
    {
        ...
        "services": [
            ...
            _svc("manage_ceremonies", "Manage ceremonies", _cols(
                view="graduation.manage_ceremonies",
                edit="graduation.manage_ceremonies",
            )),
            _svc("grad_assignments", "Graduation assignments", _crud("graduation", "graduationassignment")),
            _svc("assign_graduates", "Assign students to ceremony", _cols(
                view="graduation.assign_students",
                edit="graduation.assign_students",
            )),
    ...
    },
    {
        ...
        "services": [
            ...
            _svc("fee_config", "Configure fee plans", _cols(
                view="accounts.configure_fee_plans",
                edit="accounts.configure_fee_plans",
            )),
            ...
            _svc("accounts_clearance", "Accounts registration clearance", _cols(
                view="admissions.clear_accounts_registration",
                edit="admissions.clear_accounts_registration",
            )),
            _svc("temp_access_pass", "Temporary access passes", _cols(
                view="admissions.manage_temporary_access_pass",
                edit="admissions.manage_temporary_access_pass",
            )),
            _svc("temp_access_pass_records", "Temporary access pass records", _crud("admissions", "temporaryaccesspass")),
            _svc("payment_reconciliation", "Payment reconciliation", _cols(
                view="accounts.manage_payment_reconciliation",
                edit="accounts.manage_payment_reconciliation",
            )),
            _svc("manual_bank_payment", "Post manual bank payment", _cols(
                view="accounts.post_manual_bank_payment",
                edit="accounts.post_manual_bank_payment",
            )),
            ...
            _svc("scholarships_manage", "Manage scholarships", _cols(
                view="accounts.manage_scholarships",
                edit="accounts.manage_scholarships",
            )),
            _svc("scholarship_programmes", "Scholarship programmes", _cols(
                view="accounts.manage_scholarship_programmes",
                edit="accounts.manage_scholarship_programmes",
            )),
            _svc("scholarship_students", "Scholarship students / awards", _cols(
                view="accounts.manage_scholarship_students",
                edit="accounts.manage_scholarship_students",
            )),
    ...
    },
    {
        ...
        "services": [
            ...
            _svc("hostel_inventory", "Manage inventory", _cols(
                view="hostel.manage_hostel_inventory",
                edit="hostel.manage_hostel_inventory",
            )),
            _svc("hostel_assign", "Assign hostel / room", _cols(
                view="hostel.assign_hostel",
                edit="hostel.assign_hostel",
            )),
            _svc("hostel_allocations", "Allocations / occupancy", _crud("hostel", "hostelallocation")),
            _svc("end_allocation", "End hostel allocation", _cols(
                view="hostel.end_hostel_allocation",
                edit="hostel.end_hostel_allocation",
            )),
    ...
    },
    {
        ...
        "services": [
            ...
            _svc("staff_manage", "Manage staff", _cols(
    ...
    },
    {
        ...
        "services": [
            ...
            _svc("system_settings_access", "Access system settings", _cols(
                view="accounts.access_system_settings",
                edit="accounts.access_system_settings",
            )),
    ...
    },
    {
        ...
        "services": [
            ...
            _svc("assign_roles", "Assign roles to users", _cols(
                view="accounts.assign_roles",
                edit="accounts.assign_roles",
            )),
            _svc("groups", "Roles (Django groups)", _crud("auth", "group")),
            _svc("role_capabilities", "Role capability matrix", _cols(
                view="accounts.manage_role_capabilities",
                edit="accounts.manage_role_capabilities",
            )),

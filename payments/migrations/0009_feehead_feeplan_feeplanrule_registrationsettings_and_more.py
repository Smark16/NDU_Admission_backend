...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("payments", "0008_alter_applicationfee_amount_and_more"),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        help_text="Unique code e.g., TUITION_FEE",
                        max_length=20,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "min_tuition_payment_percentage",
                    models.DecimalField(
                        decimal_places=2,
                        default=50.0,
                ...
                (
                    "require_programme_enrollment",
                    models.BooleanField(
                        default=True,
                        help_text="Require student to have an active StudentProgrammeEnrollment (status='enrolled', i.e. commitment fee confirmed). This is the main academic enrollment gate.",
                    ),
                ),
                (
                    "skip_tuition_check",
                    models.BooleanField(
                        default=False,
                        help_text="When True, the minimum tuition payment percentage threshold is skipped entirely. Students can register regardless of how much tuition they have paid.",
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Master switch for course registration"
                    ),
                ),
                (
                    "auto_enroll_on_admission",
                    models.BooleanField(
                        default=False,
                        help_text="When enabled, students are automatically academically enrolled on admission (skips commitment fee gate).",
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Soft-cancel: charge exists but is not owed.",
                    ),
                ),

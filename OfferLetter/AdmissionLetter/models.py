...
class OfferLetterTemplate(models.Model):
    ...
    file_type = models.CharField(max_length=100, default='docx')  # 'docx' or 'pdf'
    field_positions = models.JSONField(default=dict, blank=True)  # PDF field coordinates
    programs = models.ManyToManyField(Program)
    status = models.CharField(default="active")
    start_date = models.DateField(blank=True, null=True)
    hall_of_residence = models.CharField(max_length=200, choices=HALL_CHOICES, blank=True, null=True)
